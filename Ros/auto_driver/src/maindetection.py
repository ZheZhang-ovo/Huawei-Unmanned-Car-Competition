...
class VehicleDetector():
    ...
    def __init__(self):
        ...
        self.binary_lane_seg = 0.6#0.6  # 车道线检测线比例
    ...
    # 档位控制计算值
    def spin(self,img):
        binary_results, bgr_img. offset, PdeRoad_bool, int0 = self.feedCap(img)
        self.gear = int(offset * 100)
    ...
    def feedCap(self, bgr_img):
        ...
        higher_yellow = np.array([71, 222, 255])#np.array([71, 222, 255]) # 黄色阈值上界
